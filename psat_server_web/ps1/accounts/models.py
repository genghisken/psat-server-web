...
# Imported so GlobalPermissions (which defines the has_write_access permission)
# is registered with Django's app registry and picked up by makemigrations,
# even though it isn't otherwise referenced from this module.
from .permissions import GlobalPermissions  # noqa: F401
