...
class Ps1PasswordChangeForm(PasswordChangeForm):
    """Ps1PasswordChangeForm.
    """
    error_messages = {
...
class Ps1PasswordChangeView(auth_views.PasswordChangeView):
    """Ps1PasswordChangeView.
    """
    form_class = Ps1PasswordChangeForm
