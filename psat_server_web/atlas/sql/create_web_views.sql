...
-- 2025-01-29 KWS Added new lists 12 and 13 (GalCand and Duplicates)
create or replace view atlas_v_followup12 as select o.followup_id rank,
           o.id,
           o.atlas_designation,
           o.other_designation,
           o.ra,
 ...
 left join tcs_latest_object_stats s
        on (o.id = s.id)
     where followup_id is not null
       and detection_list_id = '12'
;

create or replace view atlas_v_followup13 as select o.followup_id rank,
           o.id,
           o.atlas_designation,
           o.other_designation,
           o.ra,
...
-- 2024-07-26 KWS Added another "all" view that includes garbage and eyeball
create or replace view atlas_v_followupall_with_junk as select o.followup_id rank,
           o.id,
           o.atlas_designation,
           o.other_designation,
           o.ra,
